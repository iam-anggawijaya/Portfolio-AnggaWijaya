...
function SheetHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div data-slot='sheet-header' className={cn('py-6', className)} {...props}>
      {/* Baris atas: logo kiri, tombol close kanan */}
      <div className='flex-between'>
        <Image
          ...
          priority
        />
        <SheetPrimitive.Close className='data-[state=open]:bg-secondary cursor-pointer rounded-xs opacity-50 transition-opacity hover:opacity-100 disabled:pointer-events-none'>
          <XIcon className='size-6 text-neutral-950' />
